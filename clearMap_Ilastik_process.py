...
#load the parameters:
execfile('/d2/studies/ClearMap/ROC_iDISCO/ROC_16/parameter_file_Ilastik_ROC16.py')
...
points, intensities = thresholdPoints(points, intensities, threshold = 3000, row = (0,0));
...
table["counts"] = counts;
table["name"] = labelToName(ids);
io.writeTable(os.path.join(BaseDirectory, 'Annotated_counts_collapse.csv'), table);
